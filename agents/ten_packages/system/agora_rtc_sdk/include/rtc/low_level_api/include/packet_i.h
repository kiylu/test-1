...
struct SAudioFrame : public SMediaFrame {
  ...
  SAudioFrame() : SMediaFrame(), codec_(0), ts_(0), vad_(0), internalFlags_(0), cc_type_(0), energy_(0), audio_pts_(0) {}
};
...
struct audio_packet_t : public rtc_packet_t {
  ...
  std::string metadata_; //audio metadata from SAudioFrame extension
