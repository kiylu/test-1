...
struct ContentInspectConfigEx {
  ...
  ContentInspectConfigEx() : enable(false), ContentWorkType(CONTENT_INSPECT_WORK_CLOUD),fileUploader(nullptr),DeviceWorkType(CONTENT_INSPECT_DEVICE_INVALID),CloudWorkType(CONTENT_INSPECT_CLOUD_AGORA), extraInfo(NULL), moduleCount(0){
  }
};
