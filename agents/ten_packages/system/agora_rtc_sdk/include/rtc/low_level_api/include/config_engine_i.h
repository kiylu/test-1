...
#define CONFIGURABLE_KEY_RTC_AUDIO_AEC_FARENERGYTHR           "che.audio.aec.farend.energythreshold"
#define CONFIGURABLE_KEY_RTC_AUDIO_AEC_REFGAIN                "che.audio.aec.refgain"
...
#define INTERNAL_KEY_RTC_AUDIO_AEC_DELAY                      "che.audio.aec.delay"
#define INTERNAL_KEY_RTC_AUDIO_AEC_AUDIO_MIXING               "che.audio.aec.audio_mixing"
...
#define CONFIGURABLE_KEY_RTC_AUDIO_CAL_DELAY_PERIOD           "che.audio.calc_device_delay_period"
...
#define CONFIGURABLE_KEY_RTC_AUDIO_ENABLE_FAREND_GAIN         "che.audio.farend_gain.enable"
#define CONFIGURABLE_KEY_RTC_AUDIO_ENABLE_DIRECT_UPLINK_PROCESS        "che.audio.direct.uplink_process"
...
#define CONFIGURABLE_KEY_RTC_AUDIO_OUTPUT_ROUTING             "che.audio.output.routing"
...
#define CONFIGURABLE_KEY_DATASTREAM_ENCRYPTION_ENABLED        "rtc.use_datastream_encryption_enabled"
...
#define CONFIGURABLE_KEY_RTC_ENABLE_SYNC_RENDER_NTP_BROADCAST_DYNAMIC "rtc.video.enable_sync_render_ntp_broadcast_dynamic"
...
#define CONFIGURABLE_KEY_RTC_VIDEO_ENCODE_QUEUE_SIZE          "rtc.video.encode_queue_size"
...
#define CONFIGURABLE_KEY_VIDEO_CODEC_FORCE_SWITCH             "che.video.codec_force_switch"
//choose camera lens.(0,1:defualt, 2:dual camera, 3:triple camera) (iOS only now)
...
#define CONFIGURABLE_KEY_VIDEO_SCREEN_MAC_FALLBACK_CPU        "che.video.screen_mac_fallback_cpu"
...
/*
 Caution: This private parameter (i.e. "che.video.force_I_cache") is set to true. Remote audiences do not send intra requests.
...
//config the time threshold for video camera start but no frame incoming in seconds
#define CONFIGURABLE_VIDEO_CAMERA_NO_FRAME_INCOMING_THRESHOLD "che.video.camera.no_frame_incoming_threshold"
...
#define CONFIGURABLE_KEY_VIDEO_MAJOR_ENCODER_THREAD_NUM       "rtc.video.major_encoder_thread_num"
#define CONFIGURABLE_KEY_VIDEO_MINOR_ENCODER_THREAD_NUM       "rtc.video.minor_encoder_thread_num"
...
#define CONFIGURABLE_VIDEO_MINOR_BFRAME_NUMBER                "rtc.video.minor_bframes"
#define CONFIGURABLE_VIDEO_ENABLE_BFRAME                      "rtc.video.enable_bframe"
#define CONFIGURABLE_VIDEO_MINOR_ENABLE_BFRAME                "rtc.video.minor_enable_bframe"
...
#define CONFIGURABLE_KEY_NEW_CC_FRAMEWORK                     "rtc.new.cc_framework"
...
#define INTERNAL_KEY_RTC_DOWNLINK_QUEUING_TIME_SCALING_FACTOR "rtc.downlink_queueing_time_scaling_factor"
#define INTERNAL_KEY_RTC_DOWNLINK_QUEUING_TIME_SMOOTH_WEIGHT  "rtc.downlink_queueing_time_smooth_weight"
#define INTERNAL_KEY_RTC_DOWNLINK_QUEUING_TIME_SENSITIVE      "rtc.downlink_queueing_time_sensitive"
...
#define CONFIGURABLE_KEY_ARGUS_UPLINK_BITRATE_LOWER_THRESHOLD         "rtc.argus_uplink_bitrate_lower_threshold"
#define CONFIGURABLE_KEY_ARGUS_UPLINK_BITRATE_UPPER_THRESHOLD         "rtc.argus_uplink_bitrate_upper_threshold"
#define CONFIGURABLE_KEY_ARGUS_UPLINK_BITRATE_AUDIO_LOWER_THRESHOLD         "rtc.argus_uplink_bitrate_audio_lower_threshold"
#define CONFIGURABLE_KEY_ARGUS_UPLINK_BITRATE_AUDIO_UPPER_THRESHOLD         "rtc.argus_uplink_bitrate_audio_upper_threshold"
#define CONFIGURABLE_KEY_ARGUS_DYNAMIC_REPORT_ENABLE          "rtc.argus_dynamic_report_enable"
...
#define INTERNAL_KEY_RTC_ENABLE_TOKEN_SPECIAL_AUTH            "rtc.enable_token_special_auth"
#define CONFIGURABLE_KEY_VIDEO_TRANSPORT_OVERHEAD             "rtc.video.transport_overhead"
#define CONFIGURABLE_KEY_ACCE_MAX_RTT_NUM                      "rtc.acce_max_rtt_num"
#define CONFIGURABLE_KEY_ACCE_MAX_DURATION                    "rtc.acce_max_duration"
#define CONFIGURABLE_KEY_AUT_FEEDBACK_INTERVAL                "rtc.aut_feedback_interval"
#define CONFIGURABLE_KEY_NETWORK_E2E_CC_MODE                  "rtc.network.e2e_cc_mode"
#define CONFIGURABLE_KEY_NETWORK_PEER_COUNT_TO_DISABLE_FEEDBACK  "rtc.network.peer_count_to_disable_feedback"

#define CONFIGURABLE_KEY_INSTANT_MEDIA_RENDERING_ENABLE     "rtc.instant_media_rendering_enable"
#define CONFIGURABLE_KEY_RTC_ENABLE_REPORT_ARGUS              "rtc.enable_report_argus"
#define CONFIGURABLE_KEY_VIDEO_BW_FEEDBACK_INTERVAL            "rtc.video.bw_fb_interval"
#define CONFIGURABLE_KEY_RTC_MIN_BWE_BITRATE                   "rtc.min_bwe_bitrate"
#define CONFIGURABLE_KEY_VIDEO_ENALBE_DECODE_FB                   "rtc.video.enable_decode_fb"
...
#define CONFIGURABLE_KEY_ENABLE_EFFECT_DOWNLOAD             "rtc.enable_effect_download"
