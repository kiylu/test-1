...
class IRtcEngineEventHandler {
  ...
  */
   ...
   *  - 0(CONFIG_FETCH_TYPE_UNKNOWN): Unknown type, usually occurs when fetch fails.
   ...
   */
  virtual void onFetchConfigResult(int code, CONFIG_FETCH_TYPE configType, const char* configContent) {
    (void)code;
    (void)configType;
    (void)configContent;
  }
...
class IRtcEngine : public agora::base::IEngineBase {
  ...
  */
  ...
  /** Registers the metadata observer.
   ...
   the \ref agora::media::IMetadataObserver::getMaxMetadataSize "getMaxMetadataSize" callback.
   ...
   - < 0: Failure.
  */
  virtual int registerMediaMetadataObserver(media::IMetadataObserver *observer, media::IMetadataObserver::METADATA_TYPE type) = 0;
  ...
  /** Unregisters the metadata observer.
   ...
   - < 0: Failure.
  */
  virtual int unregisterMediaMetadataObserver(media::IMetadataObserver* observer, media::IMetadataObserver::METADATA_TYPE type) = 0;
